...
- [Neume notation examples](https://github.com/DDMAL/GensMagicalSpreadsheets#neume-notation-examples)
- [CantusDB catalogue](https://github.com/DDMAL/GensMagicalSpreadsheets#cantusdb-catalogue)
- [MS073 - Jiali's magical spreadsheet 2.0](https://github.com/DDMAL/GensMagicalSpreadsheets#ms073---jialis-magical-spreadsheet-20)
- [Another magical spreadsheet](https://github.com/DDMAL/GensMagicalSpreadsheets#another-magical-spreadsheet)
- [Correcting stemmed notes in Salzinnes](https://github.com/DDMAL/GensMagicalSpreadsheets#correcting-stemmed-notes-in-salzinnes)
- [Gen's magical spreadsheet](https://github.com/DDMAL/GensMagicalSpreadsheets#gens-magical-spreadsheet-the-og) the OG!
- [Mothra bonanza](https://github.com/DDMAL/GensMagicalSpreadsheets#mothra-bonanza-the-big-one) the big one
- [Output evaluations](https://github.com/DDMAL/GensMagicalSpreadsheets#output-evaluations)
- [UMIL master spreadsheet](https://github.com/DDMAL/GensMagicalSpreadsheets#umil-master-spreadsheet)
- [Keeping track of Bach shenanigans](https://github.com/DDMAL/GensMagicalSpreadsheets#keeping-track-of-bach-shenanigans)
- [CantusDB Volpiano discrepancies](https://github.com/DDMAL/GensMagicalSpreadsheets#cantusdb-volpiano-discrepancies)
- [Cantus Ultimus testing](https://github.com/DDMAL/GensMagicalSpreadsheets#cantus-ultimus-testing)
- [Great IIIF hunt](https://github.com/DDMAL/GensMagicalSpreadsheets#great-iiif-hunt)
...
This spreadsheet contains the record of the omr-ization and correction the MS73 manuscript in... 2024? It includes information about the different hands found in the manuscript, who corrected the folios, when, and how long it took. The spreadsheet was originally created by Jiali, but Gen (GGP) and Kyrie (KB) were the main contributors. Final mei files can be found [here](https://github.com/DDMAL/e2e-omr-resources/tree/main/resulting_mei_files/MS730).
